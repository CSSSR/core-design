...
--------- | ------------------------------------------------------------- | --------------------- | ----------------
fontStyle | font_p16_regular \| font_p24_strong \| font_roboto_slab_light | font_p16_regular      | Стиль начертания

## Свойства
Имя  | Допустимые значения             | Значение по умолчанию | Комментарий
---- | ------------------------------- | --------------------- | ----------------
type | regular \| strong \| perforator |                       | Стиль начертания
size | s \| m                          |                       | Размер заголовка
